...
needs a live socket (the card then shows "Offline / Nothing was done" in place
of the APPROVED its hold drew; checklist section 29 step 10h). Denials, expiries and `busy` refusals are never held. The
